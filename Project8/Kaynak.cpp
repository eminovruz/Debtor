...
#pragma endregion
    ...
    // 2) rhyta.com ve ya dayrep.com domenlerinde emaili olan borclulari cixartmag
     ...
     /*for_each(debtors.begin(), debtors.end(), [](Debtor d1) {
        if (d1.get_Email() == "ryreta.com" || d1.get_Email() == "dayrip.com")
          cout << d1 << endl;
      });*/
    ...
    // for_each(debtors.begin(), debtors.end(), [](Debtor d1) {
    //     if (2022 - d1.get_Birthday().get_year() >= 26 && 2022 - d1.get_Birthday().get_year() < 36)
    //         cout << d1 << endl;
    //     });
    ...
    // for_each(debtors.begin(), debtors.end(), [](Debtor d1) {
    //     if (d1.get_FullName().length() < 19 && d1.get_Phone().length() < 2)
    //         cout << d1 << endl;
    //       });
    ...
    // 7) Qishda anadan olan borclulari cixardmaq
     ...
     /*for_each(debtors.begin(), debtors.end(), [](Debtor d1) {
         if (d1.get_Birthday().get_month() == "Dekabr" || d1.get_Birthday().get_month() == "Yanvar" || d1.get_Birthday().get_month() == "Fevral")
             cout << d1 << endl;
             });*/
    ...
    // 14)Borcu en boyuk olan 5 borclunun siyahisini cixartma
   ...
   /* for_each(debtors.begin(), debtors.end(), [&](Debtor d1) {
        if (d1.get_Birthday().get_year() < 1043)
            cout << d1 << endl;
        });*/
